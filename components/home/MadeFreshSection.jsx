    ...
    return (
        <section className="px-6 pt-10 pb-6 text-center">
            <Image
                ...
                width={68}
                height={68}
                className="mx-auto mb-4 mt-5 md:w-[150px]"
            />

            <h2 className="font-hand text-[30px] md:text-[60px] text-crumb-primary mb-3">
                Made fresh, just for you
            </h2>

            <p className="text-[18px] md:text-[28px] text-[#904D23] md:w-[532px] w-[332px] mx-auto leading-tight">
            ...
            <Image
                ...
                width={220}
                height={220}
                className="mx-auto mt-8 md:w-[520px]"
            />
        </section>
    );
}